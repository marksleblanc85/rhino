<?php
	define("MAILTO" , $_POST['email']);
	define("SUBJECT" ,  'Thank you for ordering on RhinoPaper.com');
	...
	$message = '';
	$message .= 'Thank you for placing an order with Rhino Paper. We look forward to speaking to you soon'."\r\n\";
